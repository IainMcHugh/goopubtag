...
const Component = () => {
	...
	useEffect(() => {
		...
		refresh();
	}, [options, refresh, setPrivacySettings]);
	return (
		<div>
			...
			/>
			<div>
				<button type="button" onClick={() => handleClick("cdt")}>
					Child Directed Treatment
				</button>
				<button type="button" onClick={() => handleClick("npa")}>
					Non-personalized Ads
				</button>
				<button type="button" onClick={() => handleClick("rdp")}>
					Restricted Data Processing
				</button>
				<button type="button" onClick={() => handleClick("uaoc")}>
